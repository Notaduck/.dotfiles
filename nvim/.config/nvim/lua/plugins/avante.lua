return {
    ...
    opts = {
        -- Move from direct 'provider' to 'providers.default'
        providers = {
            default = 'copilot',
            -- Configure copilot under providers.copilot instead of at the top level
            copilot = {
            ...
            -- Example of alternative provider configuration (if you need it)
            -- openai = {
